// 令和6年第4回定例会のインフォグラフィックデータをSupabaseにアップロード
...
async function uploadInfographic() {
  console.log('📤 令和6年第4回定例会のインフォグラフィックデータをアップロード中...\n');

  // JSONファイルを読み込む
  const data = JSON.parse(
    fs.readFileSync('r6-4th-infographic-data.json', 'utf-8')
  );
  ...
  console.log('\n🎉 アップロード完了！');
  console.log('   http://localhost:3001/meetings/令和6年第4回定例会/topics でご確認ください');
}
