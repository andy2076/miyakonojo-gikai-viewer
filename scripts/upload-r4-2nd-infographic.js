// 令和4年第2回定例会のインフォグラフィックデータをSupabaseにアップロード
...
async function uploadInfographic() {
  console.log('📤 令和4年第2回定例会のインフォグラフィックデータをアップロード中...\n');

  // JSONファイルを読み込む
  const data = JSON.parse(
    fs.readFileSync('r4-2nd-infographic-data.json', 'utf-8')
  );
  ...
  console.log('\n🎉 アップロード完了！');
  console.log('   http://localhost:3000/meetings/令和４年第２回定例会/topics でご確認ください');
}
